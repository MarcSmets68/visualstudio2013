...
namespace MVVMVoorbeeld.ViewModel
{
    public class TekstMetOpmaakVM : ViewModelBase
    {
        ...
        public string Inhoud
        {
            ...
            set { opgemaakteTekst.Inhoud = value; RaisePropertyChanged("Inhoud");}
        }
        ...
        public Boolean Vet              
        {
            ...
            set { opgemaakteTekst.Vet = value; RaisePropertyChanged("Vet"); }
        }

        public Boolean Schuin
        {
            get { return opgemaakteTekst.Schuin; }
            set { opgemaakteTekst.Schuin = value; RaisePropertyChanged("Schuin"); }
        }
